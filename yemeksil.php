...
<input type="text" name="yemek_adi" placeholder="Sileceğiniz Yemeğin Adı" />
...
<?php 
        ...
        if($_POST){			
            $silme        =   mysqli_query($baglanti,"delete from yemekler where yemek_adi='".$_POST['yemek_adi']."'" );
			if($silme){
				echo "Yemek Başarılı Bir Şekilde Silindi!";
			}
			else {
