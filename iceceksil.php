...
<input type="text" name="icecek_adi" placeholder="Sileceğiniz İçeceğin Adı" />
...
<?php 
        ...
        if($_POST){			
            $silme        =   mysqli_query($baglanti,"delete from icecek where icecek_adi='".$_POST['icecek_adi']."'" );
			if($silme){
				echo "İçecek Başarılı Bir Şekilde Silindi!";
			}
			else {
