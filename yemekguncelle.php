...
<div id="ortasag">
   <div class="form">
<h1>Yemek Güncelleme</h1>
<form action="" method="post">

<input type="text" name="yemek_adi" placeholder="Güncellenecek Yemeğin Adı" />
<input type="text" name="yemek_fiyati" placeholder="Yemeğin Yeni Fiyatı" />
...
<?php 
        ...
        if($_POST){
            ...
            $guncelle        =    mysqli_query($baglanti,"update yemekler set yemek_fiyati='$yemek_fiyati' 
			where yemek_adi='$yemek_adi'");
