...
<div id="ortasag">
   <div class="form">
<h1>Tatlı Güncelleme</h1>
<form action="" method="post">

<input type="text" name="tatli_adi" placeholder="Güncellenecek Tatlının Adı" />
<input type="text" name="tatli_fiyati" placeholder="Tatlının Yeni Fiyatı" />
...
<?php 
        ...
        if($_POST){
            ...
            $guncelle        =    mysqli_query($baglanti,"update tatlilar set tatli_fiyati='$tatli_fiyati' 
			where tatli_adi='$tatli_adi'");
